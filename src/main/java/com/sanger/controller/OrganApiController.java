...
import com.sanger.exception.MessageException;
import com.sanger.model.Organisation;
import com.sanger.service.OrganisationService;
import java.net.URI;
...
public class OrganApiController {
	...
	public ResponseEntity<com.sanger.model.Message> exceptionMsgHandler(Exception ex) {
		com.sanger.model.Message msg = new com.sanger.model.Message();
		msg.setMessage(ex.getMessage());
		return new ResponseEntity<com.sanger.model.Message>(msg, HttpStatus.OK);
	}
